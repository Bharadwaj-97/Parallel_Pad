...
public class ClientUI extends JFrame implements KeyListener, MouseListener, ActionListener {
    ...
    public void displaySpecialCode3Message1() {
    	...
    	Thread th = new Thread(new Runnable(){
            public void run(){
            	JOptionPane.showMessageDialog(x, "You may make your edits now!","Code3_Sp1", JOptionPane.INFORMATION_MESSAGE) ;
        	}
        });
    ...
    public void displaySpecialCode3Message2() {
    	...
    	Thread th = new Thread(new Runnable(){
            public void run(){
            	JOptionPane.showMessageDialog(x, "The place where you wanted to edit does not exist anymore :/ \n Press OK to continue","Code3_Sp2", JOptionPane.INFORMATION_MESSAGE) ;
        	}
        });
    ...
    public void mouseClicked(MouseEvent e) {
    	...
    	allTextPresentInTextArea = t.getText();
    	linesInTextArea = allTextPresentInTextArea.split("\\r?\\n");
    	for (int k = 0; k < linesInTextArea.length; k++) {
            linesInTextArea[k] = linesInTextArea[k].concat("\n");
        }
